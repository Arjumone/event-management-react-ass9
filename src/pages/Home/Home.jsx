...
const Home = () => {
    ...
    return (
        ...
        <div>
           ...
           <div className=" grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 "data-aos="fade-right">
           {
       ...
       <div className=" max-w-6xl mx-auto my-4 items-center" data-aos="fade-left">
  ...
  <div className="card-body text-center items-center mt-10">
    ...
    <div className="card-actions justify-center">
      <button className="btn bg-sky-700 text-white">Booking Now</button>
            ...
            <div className=" max-w-6xl mx-auto flex  my-4 gap-5 justify-center items-center bg-sky-200 p-5 rounded-lg"data-aos="fade-right">
